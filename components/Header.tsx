        ...
        >
            ...
            <div className="flex h-12 items-center justify-between px-4  mx-auto">
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={handleStar}
                        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm  bg-[#27272a] shadow-xs px-4 py-2  h-7 cursor-pointer"
